				...
				<div className='flex flex-col md:flex-row'>
					...
					>
						...
						<p className='text-lg mb-8 pr-0 md:pr-12'>
							С Есть что поесть вам никогда не придется беспокоиться о
							том, что вы забыли какой-то ингредиент. Мы предоставляем
							подробный список всего необходимого для каждого плана
							питания, и вы можете заказать всё это всего в несколько
							кликов. Это&nbsp;так&nbsp;просто!
						</p>
