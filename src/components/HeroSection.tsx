			...
			<div className='container mx-auto px-4 pt-12 pb-4 md:py-16 flex flex-col md:flex-row items-center'>
				...
				>
					<Image
						...
						alt='Меню при гастрите — быстрое облегчение боли'
						width={600}
						height={400}
				...
				>
					...
					<p className='text-lg mb-8'>
						Специально разработанное меню, одобренное гастроэнтерологами.
						Простые рецепты, безопасные ингредиенты — быстрое облегчение
						симптомов гастрита.
					</p>
