...
const advantages = [
	{
		...
		description: `Мы подключаемся к API крупнейших сервисов доставки: Яндекс.Лавка, Самокат, СберМаркет и других. 
Каждый ингредиент сравнивается по цене, и мы подбираем самые выгодные предложения. 
Вы можете экономить до 30% на продуктовой корзине\u00A0без\u00A0усилий.`,
		type: 'price'
	},
	{
		title: 'Все в одном месте',
		short: 'Планирование, меню, список продуктов\u00A0и\u00A0доставка',
		description: `Меню, список продуктов и доставка — всё в одном приложении. 
Больше не нужно использовать несколько сервисов. Мы даем удобство "одного окна" — от идеи до\u00A0готового\u00A0блюда.`,
		type: 'all-in-one'
	},
	{
...
Вы получаете выгодные предложения сразу, без ручного поиска. Это позволяет экономить до 1500\u00A0рублей\u00A0в\u00A0месяц.`,
		type: 'discounts'
	},
	{
